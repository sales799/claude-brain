...
|---------|--------|-------|
| 929digital | IN DEVELOPMENT | 1 files |
| catalyzer-labs | PRE-LAUNCH | 1 files |
| claude-brain | Unknown | 2 files |
| competitorx | PRE-LAUNCH | 1 files |
| elovia | PRE-LAUNCH | 1 files |
| hci-intel | PHASE 1 PENDING | 1 files |
| hcitalks | PRE-LAUNCH (Phase 1 complete, Phase 2 starting) | 5 files |
